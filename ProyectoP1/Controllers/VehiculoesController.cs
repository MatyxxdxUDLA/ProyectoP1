...
namespace ProyectoP1.Controllers
{
    public class VehiculoesController : Controller
    {
        ...
        public VehiculoesController(ProyectoP1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Placa,Modelo,Marca,Anio")] Vehiculo vehiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Placa,Modelo,Marca,Anio")] Vehiculo vehiculo)
        {
            if (id != vehiculo.Id)
            {
                return NotFound();
