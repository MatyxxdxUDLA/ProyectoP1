...
namespace ProyectoP1.Controllers
{
    public class RegistroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FechaHora")] Registro registro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FechaHora")] Registro registro)
        {
            if (id != registro.Id)
            {
                return NotFound();
